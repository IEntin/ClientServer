...
( cd $SERVER_DIRECTORY/client_bin; gprof -b $SERVER_DIRECTORY/client_bin/client \
 $SERVER_DIRECTORY/client_bin/gmon.out > $SERVER_DIRECTORY/client_bin/$FIRST_CLIENT_PROFILE )
( cd $HOME/FIFOClient1 && gprof -b $HOME/FIFOClient1/client $HOME/FIFOClient1/gmon.out > \
