...
#else
    _encryptorContainer[0] = std::make_shared<CryptoPlPl>(encodedPeerPubKeyAes, signatureWithPubKey);
    _encryptorContainer[1] = std::make_shared<CryptoSodium>(encodedPeerPubKeyAes, signatureWithPubKey); 
#endif
  }
