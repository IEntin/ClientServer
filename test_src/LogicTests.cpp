...
TEST_F(LogicTest, TCP_LZ4_3600000_ENCRYPT_ENCRYPT_D) {
...
TEST_F(LogicTest, TCP_LZ4_3600000_NOTENCRYPT_NOTENCRYPT_D) {
  ServerOptions::_doEncrypt = false;
  ClientOptions::_doEncrypt = false;
  testLogic(CLIENT_TYPE::TCPCLIENT, COMPRESSORS::LZ4, 3600000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, TCP_LZ4_3600000_ENCRYPT_NOTENCRYPT_ND) {
...
TEST_F(LogicTest, TCP_ZSTD_3000000_ENCRYPT_ENCRYPT_D) {
  ServerOptions::_doEncrypt = true;
  ClientOptions::_doEncrypt = true;  
  testLogic(CLIENT_TYPE::TCPCLIENT, COMPRESSORS::ZSTD, 3000000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, TCP_SNAPPY_3000000_ENCRYPT_ENCRYPT_D) {
  ServerOptions::_doEncrypt = true;
  ClientOptions::_doEncrypt = true;  
   testLogic(CLIENT_TYPE::TCPCLIENT, COMPRESSORS::SNAPPY, 3000000, DIAGNOSTICS::ENABLED);
}
...
TEST_F(LogicTest, TCP_LZ4_20000_NOTENCRYPT__ENCRYPT_D) {
  ServerOptions::_doEncrypt = false;
  ClientOptions::_doEncrypt = true;
  testLogic(CLIENT_TYPE::TCPCLIENT, COMPRESSORS::LZ4, 20000, DIAGNOSTICS::ENABLED);
}
...
TEST_F(LogicTest, TCP_NONE_3600000_ENCRYPT_NOTENCRYPT_D) {
  ServerOptions::_doEncrypt = true;
  ClientOptions::_doEncrypt = false;
  testLogic(CLIENT_TYPE::TCPCLIENT, COMPRESSORS::NONE, 3600000, DIAGNOSTICS::ENABLED);
}
...
TEST_F(LogicTest, FIFO_NONE_100000_ENCRYPT_ENCRYPT_D) {
  ServerOptions::_doEncrypt = true;
  ClientOptions::_doEncrypt = true;
  testLogic(CLIENT_TYPE::FIFOCLIENT, COMPRESSORS::NONE, 100000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, FIFO_LZ4_3600000_ENCRYPT_NOTENCRYPT_D) {
  ServerOptions::_doEncrypt = true;
  ClientOptions::_doEncrypt = false;
  testLogic(CLIENT_TYPE::FIFOCLIENT, COMPRESSORS::LZ4, 3600000, DIAGNOSTICS::ENABLED);
}
...
TEST_F(LogicTest, FIFO_LZ4_100000_NOTENCRYPT_ENCRYPT_ND) {
  ServerOptions::_doEncrypt = false;
  ClientOptions::_doEncrypt = true;
  testLogic(CLIENT_TYPE::FIFOCLIENT, COMPRESSORS::LZ4, 100000, DIAGNOSTICS::NONE);
}

TEST_F(LogicTest, FIFO_LZ4_543_NOTENCRYPT_NOTENCRYPT_D) {
  ServerOptions::_doEncrypt = false;
  ClientOptions::_doEncrypt = false;
  testLogic(CLIENT_TYPE::FIFOCLIENT, COMPRESSORS::LZ4, 543, DIAGNOSTICS::ENABLED);
}
