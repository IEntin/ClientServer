...
TEST_F(LogicTest, TCP_LZ4_LZ4_3600000_ENCRYPT_ENCRYPT_D) {
  testLogicTcp(COMPRESSORS::LZ4, COMPRESSORS::LZ4, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT, 3600000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, TCP_NONE_NONE_3600000_NOTENCRYPT_ENCRYPT_D) {
  testLogicTcp(COMPRESSORS::NONE, COMPRESSORS::NONE, CRYPTO::NONE, CRYPTO::ENCRYPT, 3600000, DIAGNOSTICS::ENABLED);
}
...
TEST_F(LogicTest, TCP_LZ4_NONE_3600000_ENCRYPT_NOTENCRYPT_ND) {
  testLogicTcp(COMPRESSORS::LZ4, COMPRESSORS::NONE, CRYPTO::ENCRYPT, CRYPTO::NONE, 3600000, DIAGNOSTICS::NONE);
}

TEST_F(LogicTest, TCP_LZ4_LZ4_3000000_ENCRYPT_ENCRYPT_D) {
  testLogicTcp(COMPRESSORS::LZ4, COMPRESSORS::LZ4, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT, 3000000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, TCP_LZ4_ZSTD_3000000_ENCRYPT_ENCRYPT_D) {
  testLogicTcp(COMPRESSORS::LZ4, COMPRESSORS::ZSTD, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT, 3000000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, TCP_LZ4_SNAPPY_3000000_ENCRYPT_ENCRYPT_D) {
  testLogicTcp(COMPRESSORS::LZ4, COMPRESSORS::SNAPPY, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT, 3000000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, TCP_SNAPPY_LZ4_3000000_ENCRYPT_ENCRYPT_D) {
  testLogicTcp(COMPRESSORS::SNAPPY, COMPRESSORS::LZ4, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT, 3000000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, TCP_SNAPPY_SNAPPY_3000000_ENCRYPT_ENCRYPT_D) {
  testLogicTcp(COMPRESSORS::SNAPPY, COMPRESSORS::SNAPPY, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT, 3000000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, TCP_LZ4_LZ4_20000_NOTENCRYPT__ENCRYPT_D) {
  testLogicTcp(COMPRESSORS::LZ4, COMPRESSORS::LZ4, CRYPTO::NONE, CRYPTO::ENCRYPT, 20000, DIAGNOSTICS::ENABLED);
}
...
TEST_F(LogicTest, TCP_LZ4_NONE_3600000_ENCRYPT_NOTENCRYPT_D) {
  testLogicTcp(COMPRESSORS::LZ4, COMPRESSORS::NONE, CRYPTO::ENCRYPT, CRYPTO::NONE, 3600000, DIAGNOSTICS::ENABLED);
}
...
TEST_F(LogicTest, FIFO_NONE_NONE_100000_ENCRYPT_ENCRYPT_D) {
  testLogicFifo(COMPRESSORS::NONE, COMPRESSORS::NONE, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT, 100000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, FIFO_LZ4_NONE_3600000_ENCRYPT_NOTENCRYPT_D) {
  testLogicFifo(COMPRESSORS::LZ4, COMPRESSORS::NONE, CRYPTO::ENCRYPT, CRYPTO::NONE, 3600000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, FIFO_NONE_LZ4_100000_NOTENCRYPT_ENCRYPT_ND) {
  testLogicFifo(COMPRESSORS::NONE, COMPRESSORS::LZ4, CRYPTO::NONE, CRYPTO::ENCRYPT, 100000, DIAGNOSTICS::NONE);
}
...
TEST_F(LogicTest, FIFO_LZ4_LZ4_10000_ENCRYPT_ENCRYPT_ND) {
  testLogicFifo(COMPRESSORS::LZ4, COMPRESSORS::LZ4, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT,  10000, DIAGNOSTICS::NONE);
}

TEST_F(LogicTest, FIFO_SNAPPY_SNAPPY_10000_ENCRYPT_ENCRYPT_D) {
  testLogicFifo(COMPRESSORS::SNAPPY, COMPRESSORS::SNAPPY, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT,  10000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, FIFO_LZ4_SNAPPY_10000_ENCRYPT_ENCRYPT_D) {
  testLogicFifo(COMPRESSORS::LZ4, COMPRESSORS::SNAPPY, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT,  10000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, FIFO_SNAPPY_LZ4_10000_ENCRYPT_ENCRYPT_ND) {
  testLogicFifo(COMPRESSORS::SNAPPY, COMPRESSORS::LZ4, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT,  10000, DIAGNOSTICS::NONE);
}

TEST_F(LogicTest, FIFO_SNAPPY_ZSTD_10000_ENCRYPT_ENCRYPT_D) {
  testLogicFifo(COMPRESSORS::SNAPPY, COMPRESSORS::ZSTD, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT,  10000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, FIFO_ZSTD_ZSTD_10000_ENCRYPT_ENCRYPT_D) {
  testLogicFifo(COMPRESSORS::ZSTD, COMPRESSORS::ZSTD, CRYPTO::ENCRYPT, CRYPTO::ENCRYPT,  10000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, FIFO_LZ4_LZ4_10000000_ENCRYPT_NOTENCRYPT_D) {
  testLogicFifo(COMPRESSORS::LZ4, COMPRESSORS::LZ4, CRYPTO::ENCRYPT, CRYPTO::NONE, 10000000, DIAGNOSTICS::ENABLED);
}

TEST_F(LogicTest, FIFO_LZ4_LZ4_3600000_NOTENCRYPT_ENCRYPT_ND) {
  testLogicFifo(COMPRESSORS::LZ4, COMPRESSORS::LZ4, CRYPTO::NONE, CRYPTO::ENCRYPT, 3600000, DIAGNOSTICS::NONE);
}
