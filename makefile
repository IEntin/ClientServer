...
$(CPPFLAGS) -pthread $(CRYPTOPPLIB) $(BOTANCRYPTOLIB) -llz4 -lsnappy -lzstd
...
$(CLIENTBIN) : $(COMMONOBJ) $(CLIENTOBJ) $(CRYPTOPPLIB) $(BOTANCRYPTOLIB)
	$(CXX) -o $@ $(CLIENTOBJ) $(COMMONOBJ) $(CPPFLAGS) -pthread $(CRYPTOPPLIB) $(BOTANCRYPTOLIB) -llz4 -lsnappy -lzstd
...
$(CLIENTFILTEREDOBJ) $(CPPFLAGS) -pthread $(CRYPTOPPLIB) $(BOTANCRYPTOLIB) -llz4 -lsnappy -lzstd
