...
$(SERVERBIN) : $(COMMONOBJ) $(SERVEROBJ) $(COMMONHDR) $(SERVERHDR)
...
$(CLIENTBIN) : $(COMMONOBJ) $(CLIENTOBJ) $(COMMONHDR) $(CLIENTHDR)
...
$(TESTBIN) : $(TESTOBJ) $(COMMONOBJ) $(CLIENTFILTEREDOBJ) $(SERVERFILTEREDOBJ) $(COMMONHDR) $(SERVERHDR) $(CLIENTHDR) $(TESTHDR)
