...
BOOST_INCLUDES := /usr/local/boost_1_87_0
...
$(CPPFLAGS) -pthread $(CRYPTOLIB) $(BOTANCRYPTOLIB) -llz4 -lsnappy -lzstd
...
$(CLIENTBIN) : $(COMMONOBJ) $(CLIENTOBJ) $(CRYPTOLIB) $(BOTANCRYPTOLIB)
	$(CXX) -o $@ $(CLIENTOBJ) $(COMMONOBJ) $(CPPFLAGS) -pthread $(CRYPTOLIB) $(BOTANCRYPTOLIB) -llz4 -lsnappy -lzstd
...
$(CLIENTFILTEREDOBJ) $(CPPFLAGS) -pthread $(CRYPTOLIB) $(BOTANCRYPTOLIB) -llz4 -lsnappy -lzstd
