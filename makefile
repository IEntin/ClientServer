...
serverX : $(COMMONOBJ) $(BUSINESSOBJ) $(SERVEROBJ) $(CRYPTOLIB) $(BOTANCRYPTOLIB)
...
$(TESTBIN) : $(COMMONOBJ) $(BUSINESSOBJ) $(SERVERFILTEREDOBJ) $(CLIENTFILTEREDOBJ) $(TESTOBJ) $(CRYPTOLIB) $(BOTANCRYPTOLIB)
